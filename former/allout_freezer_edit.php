...
<input type="hidden" value="<?php echo $row['Allout_id'];?>" name="Allout_id" />
  ...
  ?>
    ...
    <tr>
      <td>Allout_status</td>
      <td><input name="allout_status" id="allout_status" type="radio" value="yes" class="validate[required] "/>
        Yes &nbsp;
          <input name="allout_status" id="allout_status" type="radio" value="no" class="validate[required] "/>
        No</td>
    </tr>
    <tr>
