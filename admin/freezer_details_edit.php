...
<table width="587" height="254" border="0">
    <tr>
      ...
      <td><select name="Storage_details_id" class="validate[required] form-control" id="Storage_details_id">
  ...
  ?>
    ...
    <tr>
      <td>Freezer_no</td>
      <td><input name="Freezer_no" type="text" id="Freezer_no" value="<?php echo $row['Freezer_no'];?>" class="validate[required] form-control"/></td>
    </tr>
    <tr>
      <td>Capacity</td>
