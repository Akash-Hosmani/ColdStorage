...
$sql="select * from former_details where Former_id='$id'";
...
<input type="hidden" value="<?php echo $row['Former_id'];?>" name="Former_id" />
  ...
  <table width="557" height="393" border="0">
    ...
    <tr>
      <td>Former_code</td>
      <td><input name="code" type="text" id="code" value="<?php echo $row['Former_code'];?>" class="validate[required,custom[onlyNumber]] form-control" /></td>
    </tr>
    <tr>
      <td>address</td>
